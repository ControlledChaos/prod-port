...
class Users_Callbacks {
	...
	public function block_gravatar( $args ) {
		...
		$option = get_option( 'ppp_block_gravatar' );

		$html = '<p><input type="checkbox" id="ppp_block_gravatar" name="ppp_block_gravatar" value="1" ' . checked( 1, $option, false ) . '/>';

		$html .= '<label for="ppp_block_gravatar"> ' . $args[0] . '</label></p>';

...
class Dashboard {
	...
	private function dependencies() {
        ...
        require PPP_PATH . 'admin/dashboard/class-dashboard-widget.php';

        // Get the welcome panel class.
        require PPP_PATH . 'admin/dashboard/class-welcome.php';
    ...
    public function metaboxes() {
        ...
        if ( ppp_acf_options() ) {
            ...
            $hide = get_field( 'ppp_dashboard_hide_widgets', 'option' );
        ...
        // If Advanced Custom Fields is not active.
            ...
            // Get options.
            $welcome    = get_option( 'ppp_hide_welcome' );
            $gutenberg  = get_option( 'ppp_hide_try_gutenberg' );
            $wp_news    = get_option( 'ppp_hide_wp_news' );
            $quickpress = get_option( 'ppp_hide_quickpress' );
            $at_glance  = get_option( 'ppp_hide_at_glance' );
            $activity   = get_option( 'ppp_hide_activity' );
    ...
    public function add_help() {
		...
		$screen->add_help_tab( [
			...
			'title'    => __( 'Welcome Panel', 'prod-port' ),
			'content'  => null,
		...
		$screen->add_help_tab( [
			...
			'title'    => __( 'Dashboard Widgets', 'prod-port' ),
			'content'  => null,
	...
	public function help_welcome_panel() {
        ...
        include_once PPP_PATH . 'partials/help/help-welcome-panel.php';
	...
	public function help_dashboard_widgets() {
        ...
        include_once PPP_PATH . 'partials/help/help-dashboard-widgets.php';
    ...
    public function help_dashboard_sidebar() {
        ...
        $html  = sprintf(
            '<h4>%1s %2s</h4>',
            __( 'Custom Dashboard for', 'prod-port' ),
             get_bloginfo( 'name' )
        );
	...
	public function styles() {
        ...
        if ( $screen->id == 'dashboard' ) {
            wp_enqueue_style( PPP_ADMIN_SLUG . '-dashboard', PPP_URL .  'admin/dashboard/assets/css/dashboard.min.css', [], null, 'screen' );
        }

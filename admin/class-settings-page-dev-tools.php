...
class Settings_Page_Dev_Tools {
	...
	public function settings_page() {
		...
		$this->page_help_section = add_submenu_page(
			'tools.php',
			__( 'Website Development', 'prod-port' ),
			__( 'Site Development', 'prod-port' ),
			'manage_options',
			PPP_ADMIN_SLUG . '-dev-tools',
			[ $this, 'page_output' ]
		);
	...
	public function page_output() {
		...
		require PPP_PATH . 'admin/partials/settings-page-development.php';
	...
	public function help_dev_info_output() {
		...
		include_once PPP_PATH . 'admin/partials/help/help-dev-info.php';
 ...
 */
function ppp_settings_page_dev_tools() {

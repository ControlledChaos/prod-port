...
class Admin_Menu {
    ...
    public function __construct() {
        ...
        if ( ppp_acf_options() ) {
            ...
            $options = get_field( 'ppp_admin_hide_links', 'option' );
        ...
        // Get links option.
        if ( ppp_acf_options() ) {
            $links = get_field( 'ppp_links_manager', 'option' );
        } else {
            $links = get_option( 'ppp_hide_links' );
        }
    ...
    public function hide() {
        ...
        if ( ppp_acf_options() ) {
            ...
            // Get options.
            $appearance = get_option( 'ppp_hide_appearance' );
            $plugins    = get_option( 'ppp_hide_plugins' );
            $users      = get_option( 'ppp_hide_users' );
            $tools      = get_option( 'ppp_hide_tools' );
    ...
    public function menus_widgets() {
        ...
        if ( ppp_acf_options() ) {
            ...
            $menus_link   = get_field( 'ppp_menus_position', 'option' );
            $widgets_link = get_field( 'ppp_widgets_position', 'option' );
        ...
        // If ACF is not active.
            ...
            $menus_link   = get_option( 'ppp_menus_position' );
            $widgets_link = get_option( 'ppp_widgets_position' );

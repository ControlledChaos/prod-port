...
class Settings_Fields_Site {
	...
	private function dependencies() {
		...
		require PPP_PATH . 'admin/class-settings-fields-site-dashboard.php';

		// Settings for the Admin Menu tab.
		require PPP_PATH . 'admin/class-settings-fields-site-admin-menu.php';

		// Settings for the Admin Menu tab.
		require PPP_PATH . 'admin/class-settings-fields-site-admin-pages.php';

		// Settings for the Admin Menu tab.
		require PPP_PATH . 'admin/class-settings-fields-site-users.php';

		// Callbacks for the Meta/SEO tab.
		require PPP_PATH . 'admin/class-settings-fields-site-meta-seo.php';
	...
	public function site_settings() {
		...
		$defaults = [
			...
			'settings_link_label' => __( 'Site Settings', 'prod-port' ),
		...
		return apply_filters ( 'ppp_site_settings', $defaults );
 ...
 */
function ppp_settings_fields_site() {

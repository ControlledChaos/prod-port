...
class Meta_Image {
	...
	public function __construct() {
		...
		add_action( 'ppp_meta_image_tag', [ $this, 'image' ] );
	...
	public function image() {
		...
		if ( ppp_acf_options() ) {
			...
			$blog_image    = get_field( 'ppp_meta_blog_image', 'option' );
			$default_image = get_field( 'ppp_meta_default_image', 'option' );
